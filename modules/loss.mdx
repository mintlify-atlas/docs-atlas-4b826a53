...
- **Subtraction**: `fxp_addsub` with `sub=1` computes `H - Y`
  - See `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/fixedpoint.sv:186` for implementation
  - Handles sign extension and overflow detection

- **Multiplication**: `fxp_mul` scales the difference by `2/N`
  - See `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/fixedpoint.sv:278` for implementation
...
See `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/vpu.sv:268-302` for the loss routing logic.
...
- Parent module: `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/loss_parent.sv`
- Child module: `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/loss_child.sv`