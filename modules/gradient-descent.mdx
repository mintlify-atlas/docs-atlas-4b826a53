...
See `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/gradient_descent.sv:50-55` for the implementation.
...
See `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/gradient_descent.sv:58-60`.
...
- **Multiplication** (`fxp_mul`):
  ...
  - See `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/gradient_descent.sv:33-38`
  - Implementation at `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/fixedpoint.sv:278`

- **Subtraction** (`fxp_addsub`):
  - Computes `value - (grad × lr)` with `sub=1` mode
  - See `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/gradient_descent.sv:40-46`
  - Implementation at `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/fixedpoint.sv:186`
...
See `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/gradient_descent.sv:48-62`.
...
See `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/gradient_descent.sv:64-77`.
...
- Module implementation: `/home/daytonahttps://github.com/tiny-tpu-v2/tiny-tpu/blob/main/src/gradient_descent.sv`